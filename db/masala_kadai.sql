CREATE DATABASE  IF NOT EXISTS `masala_kadai` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `masala_kadai`;

-- MySQL dump 10.13  Distrib 8.0.40, for Win64 (x86_64)
--
-- Host: localhost    Database: masala_kadai
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Masala Dosa',6.00),(2,'Paneer Tikka',10.00),(3,'Butter Chicken',9.00),(4,'Vegetable Biryani',8.00),(5,'Samosa',2.00),(6,'Tandoori Roti',3.00),(7,'Idly',5.00),(8,'Masala Tea',1.00);
...
INSERT INTO `order_tracking` VALUES (1,'delivered'),(2,'in transit'),(3,'in progress'),(4,'in progress'),(5,'in progress');
...
INSERT INTO `orders` VALUES (1,1,2,12.00),(1,3,1,9.00),(2,4,3,24.00),(2,6,2,6.00),(2,8,4,4.00),(3,7,2,10.00),(4,5,2,4.00),(4,8,1,1.00),(5,1,3,18.00),(5,7,2,10.00);
/*!40000 ALTER TABLE `orders` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'masala_kadai'
--
...
-- Dump completed on 2025-02-21 23:56:25
